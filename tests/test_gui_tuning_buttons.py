...
class TuningFormTests(unittest.TestCase):
    ...
    def test_applying_a_tuning_lands_in_the_saved_config(self) -> None:
        self.app._apply_tuning_to_form(1, self._tuning())
        self.app.root.update_idletasks()
    ...
    def test_the_tuning_does_not_touch_local_habits(self) -> None:
