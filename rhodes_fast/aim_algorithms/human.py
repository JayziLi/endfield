...
class FeedforwardWind(Feedforward):
    ...
    PARAMS: tuple[Param, ...] = Feedforward.PARAMS + (
        ...
        Param("wind_decay_px", 40.0, 5.0, 200.0, "风力归零距离（像素）"),
...
class WindMouse:
    ...
    PARAMS: tuple[Param, ...] = (
        Param("gravity", 4.0, 0.25, 40.0, "重力（像素/帧²）"),
        Param("wind", 2.0, 0.0, 20.0, "风力"),
        Param("max_step", 3.0, 0.5, 15.0, "单帧速度上限（像素）"),
        Param("damp_px", 25.0, 2.0, 100.0, "末端阻尼距离（像素）"),
